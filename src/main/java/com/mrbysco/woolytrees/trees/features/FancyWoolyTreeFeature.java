...
public class FancyWoolyTreeFeature extends AbstractTreeFeature<TreeFeatureConfig> {
    public FancyWoolyTreeFeature(Function<Dynamic<?>, ? extends TreeFeatureConfig> p_i225803_1_) {
        super(p_i225803_1_);
    }
    ...
    private int func_227235_a_(IWorldGenerationReader p_227235_1_, Random p_227235_2_, BlockPos p_227235_3_, BlockPos p_227235_4_, boolean p_227235_5_, Set<BlockPos> p_227235_6_, MutableBoundingBox p_227235_7_, TreeFeatureConfig p_227235_8_) {
        if (!p_227235_5_ && Objects.equals(p_227235_3_, p_227235_4_)) {
            ...
            for(int j = 0; j <= i; ++j) {
                ...
                if (p_227235_5_) {
                    this.func_227217_a_(p_227235_1_, blockpos1, p_227235_8_.trunkProvider.getBlockState(p_227235_2_, blockpos1), p_227235_7_);
    ...
    private void func_227232_a_(IWorldGenerationReader p_227232_1_, Random p_227232_2_, int p_227232_3_, BlockPos p_227232_4_, List<FancyWoolyTreeFeature.ExtendedPos> p_227232_5_, Set<BlockPos> p_227232_6_, MutableBoundingBox p_227232_7_, TreeFeatureConfig p_227232_8_) {
        for(FancyWoolyTreeFeature.ExtendedPos FancyWoolyTreeFeature$extendedpos : p_227232_5_) {
            if (this.func_227239_b_(p_227232_3_, FancyWoolyTreeFeature$extendedpos.func_227243_r_() - p_227232_4_.getY())) {
                this.func_227236_a_(p_227232_1_, p_227232_2_, FancyWoolyTreeFeature$extendedpos, p_227232_6_, p_227232_7_, p_227232_8_);
            }
        }
    ...
    private void func_227240_b_(IWorldGenerationReader p_227240_1_, Random p_227240_2_, int p_227240_3_, BlockPos p_227240_4_, List<FancyWoolyTreeFeature.ExtendedPos> p_227240_5_, Set<BlockPos> p_227240_6_, MutableBoundingBox p_227240_7_, TreeFeatureConfig p_227240_8_) {
        for(FancyWoolyTreeFeature.ExtendedPos FancyWoolyTreeFeature$extendedpos : p_227240_5_) {
            int i = FancyWoolyTreeFeature$extendedpos.func_227243_r_();
            BlockPos blockpos = new BlockPos(p_227240_4_.getX(), i, p_227240_4_.getZ());
            if (!blockpos.equals(FancyWoolyTreeFeature$extendedpos) && this.func_227239_b_(p_227240_3_, i - p_227240_4_.getY())) {
                this.func_227235_a_(p_227240_1_, p_227240_2_, blockpos, FancyWoolyTreeFeature$extendedpos, true, p_227240_6_, p_227240_7_, p_227240_8_);
            }
        }
    ...
    public boolean func_225557_a_(IWorldGenerationReader generationReader, Random rand, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
        ...
        if (i == -1) {
            ...
            int i1 = i - 5;
            List<FancyWoolyTreeFeature.ExtendedPos> list = Lists.newArrayList();
            list.add(new FancyWoolyTreeFeature.ExtendedPos(p_225557_3_.up(i1), l));
                    ...
                    for(int j1 = 0; j1 < k; ++j1) {
                        ...
                        if (this.func_227235_a_(generationReader, rand, blockpos, blockpos1, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                            ...
                            if (this.func_227235_a_(generationReader, rand, blockpos2, blockpos, false, p_225557_4_, p_225557_6_, p_225557_7_) == -1) {
                                list.add(new FancyWoolyTreeFeature.ExtendedPos(blockpos, blockpos2.getY()));
                            }
                        }
                    }
                }
