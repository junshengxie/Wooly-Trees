...
public class WoolyFeatureConfig {
    ...
    public static final BaseTreeFeatureConfig FANCY_TREE_CONFIG = (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WHITE_WOOL_LOG), new SimpleBlockStateProvider(GREEN_WOOL_LEAVES), new FancyFoliagePlacer(2, 0, 4, 0, 4), new FancyWoolPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0, OptionalInt.of(4)))).setIgnoreVines().func_236702_a_(Heightmap.Type.MOTION_BLOCKING).build();
    ...
    public static BlockState getRandomleaves() {
        ...
        if(WoolyTags.WOOLY_LEAVES != null && !WoolyTags.WOOLY_LEAVES.getAllElements().isEmpty()) {
    ...
    public static BlockState getRandomLog() {
        ...
        if(WoolyTags.WOOLY_LOGS != null && !WoolyTags.WOOLY_LOGS.getAllElements().isEmpty()) {
    ...
    public static BaseTreeFeatureConfig getFancyJebWithBeehives() {
        return (new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(getRandomLog()), new SimpleBlockStateProvider(getRandomleaves()), new FancyFoliagePlacer(2, 0, 4, 0, 4), new FancyWoolPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0, OptionalInt.of(4)))).setIgnoreVines().func_236702_a_(Heightmap.Type.MOTION_BLOCKING).build();
    }
